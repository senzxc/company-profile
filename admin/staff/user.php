...
<body>
    <main>
        <nav>
            <div class="profile">
                <img src="<?= $_SESSION['profile2']; ?>" alt="admin.png">
                <h1><?= $_SESSION['name']; ?></h1>
            </div>

            <div class="menus-wrapper">
                <a href="index.php" class="menu-flex dashboard-non">
                ...
                <a href="messages.php" class="menu-flex">
        ...
        <section class="users">
            ...
            ?>
                <div class="table-user">
                    ...
                    <h5 class="main main4"><?= $row['role']; ?></h5>
